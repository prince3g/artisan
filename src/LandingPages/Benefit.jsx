      ...
      <Link to="/benefits" className="IIai-1-Box-Card active-IIai-1-Box-Card">
        ...
        <div className='IIai-2'>
            <div className='Ooo-header'>
                <h3 className='mid-text'>How This Platform Benefits Nigerian Homeowners </h3>
                <p>With so many tradesperson and service providers to choose from, it’s essential to find professionals who understand the local needs and deliver consistently high-quality work. Here’s how our platform ensures you get the best service for your home:</p>
            </div>

            <div className='Ooo-Body'>
            <img src={ooAdi2}></img>
                <h4>Verified Profiles and Reviews</h4>
                <p>Each tradesperson’s profile comes with authentic reviews from other homeowners, so you can see what to expect before hiring.</p>
                ...
                <p>Ready to make your home improvement plans a reality? Join our app today, find the perfect tradesperson for any job, and enjoy a seamless experience from start to finish. With trusted professionals, fair pricing, and all the advice you need, we’re here to make sure your home is always in excellent hands.</p>
