...
//   const [isSubmitting, setIsSubmitting] = useState(false); // New state variable for loader
...
//                 Back
//               </button>
//               <button type="submit" className="post-job-btn" onClick={handleSubmit} disabled={isSubmitting}>
