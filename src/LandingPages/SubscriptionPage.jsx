    ...
    <div className='subb-boxes-sec'>
      ...
      <div className='subb-boxes-Grid'>
        ...
        <div className='subb-box'>
          ...
          <ul>
            <li><CheckIcon />  Cost-effective solution for solo artisans or those experimenting with online sales</li>
            <li><CheckIcon />  Quick to set up with minimal complexity</li>
            <li><CheckIcon />  Access to essential features without a large investment</li>
          </ul>
        ...
        <div className='subb-box'>
          ...
          <ul>
            <li><CheckIcon />  Balanced feature set for small-to-medium artisan businesses looking to grow</li>
            <li><CheckIcon />  Multiple payment options and deeper analytics to scale your operations</li>
            <li><CheckIcon />  Enough customization to reflect your brand’s unique identity</li>
          </ul>
        ...
        <div className='subb-box'>
          ...
          <ul>
            <li><CheckIcon /> Enterprise-level tools and dedicated, priority support for seamless operations</li>
            <li><CheckIcon /> Full design freedom, advanced security, and comprehensive analytics</li>
            <li><CheckIcon /> Ideal for established businesses needing robust performance and specialized features</li>
          </ul>
