      ...
      <Link to="/benefits" className="IIai-1-Box-Card">
        ...
        <div className='IIai-2'>
            <div className='Ooo-header'>
                <h3 className='mid-text'>Essential Advice for Nigerian Homeowners</h3>
                ...
                <p>Settle in with a cup of tea, and explore these tips designed to help you find the right tradesperson for every job in your home.</p>
            </div>
            ...
            <div className='Ooo-Body'>
                ...
                <h4>Choosing the Right Tradesperson</h4>
                <p>When it comes to your home, trust is everything. All tradespeople on our platform go through a thorough screening process before joining, ensuring that you only hire professionals with proven skills and reliability. Each tradesperson’s profile includes verified reviews, making it simple for you to pick the best.</p>
    	        <h4>Smart Budgeting and Project Planning</h4>
                <p>Taking on a home improvement project can feel overwhelming, but with our financial advice and budgeting tips, you can stay on top of costs. Our platform provides quotes from different tradesperson, so you can make informed choices without breaking the bank. Additionally, with our project planning resources, you can keep track of timelines and ensure everything goes smoothly.</p>
                <h4>Enjoy Reliable and Consistent Quality</h4>
                <p>Every tradesperson on our platform meets rigorous quality standards. With this app, you can expect top-quality work delivered on time. Plus, if any issues arise during or after the job, we’re here to support you in resolving them quickly.</p>
